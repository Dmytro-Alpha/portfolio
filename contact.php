                    ...
                    <div class="dan-a dan-card">
                      <div class="dan-table p-15-15">
                        <ul>
                          ...
                          <li>
                            <h6>Street:</h6><span>Zaporizhzhya</span>
                          </li>
                        </ul>
                      </div>
                    </div>
                  ...
                  <div class="col-lg-4">
                    ...
                    <div class="dan-a dan-card">
                      <div class="dan-table p-15-15">
                        <ul>
                          <li>
                            <h6>Email:</h6><span>kapustynskyidmytro@gmail.com</span>
                          </li>
                          <!-- <li>
                            <h6>Phone:</h6><span>+44 2032860022</span>
                          </li> -->
                          <!-- <li>
                            <h6>Linkedin:</h6><span>Dmytro-Dmytro-301238226</span>
                          </li> -->
                          <li>
                            <h6>GitHub:</h6><span>dmytro-alpha</span>
                          </li>
                          <li>
